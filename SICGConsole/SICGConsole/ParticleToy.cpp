...
// global variables for window resizing/mouse interaction
static int win_id;
...
static void init_default() {
	...
	// Create two groups of three particles, attach them to each other, then add a
...
// Initialize a scene with rotations.
