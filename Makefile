...
ifeq ($(OS),Windows_NT)
	...
	RM = rm -vf
	INCLUDE = $(INC_LINUX)
	CXX_EXTRA_FLAGS = -framework GLUT -framework OpenGL -framework Cocoa -I/usr/local/Cellar/libpng/1.6.37/include/libpng16 -L/usr/local/Cellar/libpng/1.6.37/lib -lpng16
endif
